...
public class AddtocartPrinteddress {
	...
	public boolean Addprinteddress(WebDriver driver)
	
	{
		WebElement Searchquery=driver.findElement(serchboxq);
		Searchquery.clear();
		Searchquery.sendKeys("Printed Summer Dresses");
	    ...
	    System.out.println("Printed Summer Dress, size medium, colour orange added to cart");
